...
# 构建新的词典 和词向量矩阵
def get_new_dict(
    type_vec_path, type_word_path, final_vec_path, final_word_path
):  # 词标签，词向量
...
if __name__ == "__main__":
    ps_path = "../DataProcess/embeddings/10_10/python_struc2vec1/data/python_struc2vec.txt"  # 239s
    ps_path_bin = "../DataProcess/embeddings/10_10/python_struc2vec.bin"  # 2s

    sql_path = "../DataProcess/embeddings/10_8_embeddings/sql_struc2vec.txt"
    sql_path_bin = "../DataProcess/embeddings/10_8_embeddings/sql_struc2vec.bin"
    ...
    python_word_path = "../DataProcess/data/word_dict/python_word_vocab_dict.txt"
    python_word_vec_path = (
        "../DataProcess/embeddings/python/python_word_vocab_final.pkl"
    )
    python_word_dict_path = (
        "../DataProcess/embeddings/python/python_word_dict_final.pkl"
    )

    sql_word_path = "../DataProcess/data/word_dict/sql_word_vocab_dict.txt"
    sql_word_vec_path = "../DataProcess/embeddings/sql/sql_word_vocab_final.pkl"
    sql_word_dict_path = "../DataProcess/embeddings/sql/sql_word_dict_final.pkl"
    ...
    # =======================================最后打标签的语料========================================
    # sql 待处理语料地址
    new_sql_staqc = "../DataProcess/ulabel_data/staqc/sql_staqc_unlabled_data.txt"
    new_sql_large = "../DataProcess/ulabel_data/large_corpus/multiple/sql_large_multiple_unlable.txt"
    # sql大语料最后的词典
    large_word_dict_sql = "../DataProcess/ulabel_data/sql_word_dict.txt"

    # sql最后的词典和对应的词向量
    sql_final_word_vec_path = (
        "../DataProcess/ulabel_data/large_corpus/sql_word_vocab_final.pkl"
    )
    sql_final_word_dict_path = (
        "../DataProcess/ulabel_data/large_corpus/sql_word_dict_final.pkl"
    )
    ...
    staqc_sql_f = "../DataProcess/ulabel_data/staqc/seri_sql_staqc_unlabled_data.pkl"
    large_sql_f = "../DataProcess/ulabel_data/large_corpus/multiple/seri_ql_large_multiple_unlable.pkl"
    ...
    # python
    new_python_staqc = "../DataProcess/ulabel_data/staqc/python_staqc_unlabled_data.txt"
    new_python_large = "../DataProcess/ulabel_data/large_corpus/multiple/python_large_multiple_unlable.txt"
    final_word_dict_python = "../DataProcess/ulabel_data/python_word_dict.txt"
    large_word_dict_python = "../DataProcess/ulabel_data/python_word_dict.txt"

    # python最后的词典和对应的词向量
    python_final_word_vec_path = (
        "../DataProcess/ulabel_data/large_corpus/python_word_vocab_final.pkl"
    )
    python_final_word_dict_path = (
        "../DataProcess/ulabel_data/large_corpus/python_word_dict_final.pkl"
    )
    ...
    # 处理成打标签的形式
    staqc_python_f = (
        "../DataProcess/ulabel_data/staqc/seri_python_staqc_unlabled_data.pkl"
    )
    large_python_f = "../DataProcess/ulabel_data/large_corpus/multiple/seri_python_large_multiple_unlable.pkl"
